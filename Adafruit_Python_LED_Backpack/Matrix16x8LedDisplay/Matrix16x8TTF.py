...
class Matrix16x8Display(object):
    ...
    def __init__(self, display1_address=0x72, repeat_delay=0, scroll_delay=0.05, brightness=4, rotate_text=True, font_size=9, font_path="/home/pi/dev/MatrixDisplay/fonts/SFPixelate.ttf"):
...
if __name__ == '__main__':
    ...
    matrix = Matrix16x8Display(font_path="/home/pi/Adafruit_Python_LED_Backpack/Matrix16x8LedDisplay/fonts/PressStart2P.ttf", brightness=4, repeat_delay=0, scroll_delay=0.02, rotate_text=False)
    matrix.scroll_message(display_message="The quick brown fox jumps over the lazy dog.  PressStart2P.ttf", num_scrolls=1)
    matrix = Matrix16x8Display(font_path="/home/pi/Adafruit_Python_LED_Baackpack/Matrix16x8LedDisplay/fonts/8BitWonder.ttf", brightness=4, repeat_delay=0,scroll_delay=0.02, rotate_text=False)
